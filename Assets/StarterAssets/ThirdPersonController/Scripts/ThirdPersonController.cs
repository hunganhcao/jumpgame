...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void Move()
        {
            ...
            Vector3 inputDirection = (PointEnd.transform.position-PointStart.transform.position).normalized;
            // move the player
		...
		private void OnTriggerEnter(Collider other)
		{
            ...
            //{
            //    Debug.Log((transform.position-jumpLine.position).magnitude);
